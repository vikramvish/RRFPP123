                                ...
                                <tbody>
                                    @foreach ($user as $users)
                                        <tr>
                                            ...
                                            <td class="txt-oflo">
                                                {{-- if($product->status == '1'){
                                        <a class="btn" href="{{ url('status-update',$users->DepartmentId) }}" class="btn btn-success editbtn btn-sm">
                                            Active</a>
                                     else{
                                        <a class="btn" href="{{ url('status-update',$users->DepartmentId) }}" class="btn btn-success editbtn btn-sm">
                                            InActive</a>
                                            ...
                                            <td style="text-align: center">
                                                <a class="btn"
                                                    href="{{ url('DeptEdit/' . $users->DepartmentId) }}">
                                                ...
                                                <a class="btn"
                                                    ...
                                                    <button type="button" value=""
                                                        class="btn btn-primary editbtn btn-sm" data-toggle="modal"
                                                        data-target="#exampleModal">Update Meta
                                                        Content</button></a>
                                                {{-- <a class="btn" href="{{ url('deletedept/' . $users->DepartmentId) }}"
