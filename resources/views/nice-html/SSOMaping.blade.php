                ...
                <table id="monthly_report" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center">Name of Person</th>
                            <th style="text-align: center">Designation</th>
                            <th style="text-align: center;width: 74px;">Role</th>
                            <th style="text-align: center;width: 200px;">Assigned Department</th>
                            <th style="text-align: center">Action</th>
                            <th style="text-align: center; width: 200px;">Edit</th>
                        </tr>
                    </thead>
                    <tbody id="table-body">
                        @foreach ($user as $users)
                        <tr>
                            <th style="text-align: center">{{ $users->user_id }}</th>
                            ...
                            {{-- <td>
                                @foreach($users->departments as $department)
                                    <button type="button" class="btn btn-primary" style="padding: 2px;" @disabled(true)>{{ $department->DepartmentName }}</button>
                                @endforeach
                            </td> --}}
                            <td>
                            ...
                            <td class="txt-oflo">
                                ...
                                {{-- <a class="bi bi-check-circle-fill" style="color: green;" class="btn" href="">
                                </a> --}}
                            ...
                            <td style="text-align: center">
                                <a class="btn" href="{{ url('ssoEdit/' . $users->user_id) }}">
                                    <button type="button" value="" class="btn btn-primary editbtn btn-sm"
                                        data-toggle="modal" data-target="#exampleModal">
                                        <i class="bi bi-pencil"></i>
                                        <!-- Replace "bi bi-pencil" with the appropriate class for the desired icon library -->
                                    </button>
                                </a>
                                <a class="btn" href="{{ url('deptmapping/' . $users->UserName) }}">
                                    <button type="button" value="" class="btn btn-primary editbtn btn-sm"
                                        data-toggle="modal" data-target="#exampleModal">
