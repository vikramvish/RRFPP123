            ...
            <div class="fillter">
                <form action="" method="GET" id="fillter_data">
                    <div class="filler_coll">
                        @if(session('roleId') == 1)
                        <select data-column="0" class="form-select filter-select" name="scheme" id="dropdown"
                            placeholder="Select Scheme">
                            <option value="all">All Department</option>
                            @foreach ($dept as $schemes)
                            @if ($schemes->IsActive == 1)
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <a class="btn" href="{{ url('SchConfigration/') }}">
                                    <button type="button" value="" class="btn btn-primary editbtn btn-sm"
                                        data-toggle="modal" data-target="#exampleModal">Scheme Configration</button></a>
